    ...
    public partial class Client_Form : Form
    {
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            ...
            {   
                ...
                _clientEvent.ButtonStatusChange();
        ...
        public void ReceiveDataThread()
        {
            while (true)
            {
                ...
                catch (Exception e)
                {
                    ...
                    {
                        this.Invoke(new DeligateButtonChange(_clientEvent.ButtonStatusChange));
                        this.Invoke(new DeligateDisconnectMessgae(_clientEvent.DisconnectMessgae));
                    }
                    catch { }
                    break;
                }
